...
import { ArrowDownToLine, ArrowUpToLine, Copy, GripVertical, Trash } from "lucide-react";
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <button
              ...
              className="text-muted-foreground/50 hover:text-foreground cursor-grab touch-none rounded-sm p-1 opacity-0 group-hover/row:opacity-100"
            >
